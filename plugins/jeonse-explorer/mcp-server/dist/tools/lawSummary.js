...
export async function getJeonseFraudLawSummary(input) {
...
const SUMMARIES = {
    law_overview: {
        ...
        content: '2023년 6월 1일 시행된 한시법으로, 전세사기 피해자에게 긴급 주거지원·금융지원·법적 보호를 제공하기 위해 제정. 피해자 결정신청을 통해 인정받으면 우선매수권·LH 매입·경공매 유예·금융 지원 등의 혜택을 받을 수 있다. 시행 후 누적 35,909건이 인정되었다(2025.12 기준, 가결률 약 62.9%).',
        key_points: [
            '시행일: 2023년 6월 1일',
            '한시법 (10년 시한)',
            '관할 부처: 국토교통부',
    ...
    eligibility_requirements: {
        ...
        content: '전세사기특별법 제3조에 따라 피해자로 인정되려면 다음 4가지 요건을 모두 충족해야 한다. 4가지가 모두 충족된다고 자동 인정되는 것은 아니며, 위원회 심의를 거쳐 결정된다.',
        key_points: [
    ...
    recovery_options: {
        ...
        content: '전세보증금 회수는 다층적 메커니즘으로 보호된다. 가장 강력한 보호는 우선변제권(전입신고 + 확정일자)이며, 그 외 임차권등기명령·전세권 설정·LH 우선매수권·매입 제도 등이 있다. 피해자 인정 시 LH 매입 가능성이 추가된다.',
        key_points: [
    ...
    sentencing_guidelines: {
        ...
        content: '대법원 양형위원회의 사기범죄 양형기준은 이득액에 따라 5개 유형으로 구분된다. 일반사기와 조직적 사기로 분류되며, 조직적 사기는 가중된다. 5억원 이상은 특정경제범죄가중처벌법(특경법) 적용 대상이다. 빌라왕 사건은 다수의 피해자·주택을 동원한 조직적 사기로 분류되는 경우가 많다.',
        key_points: [
    ...
    procedure_guide: {
        ...
        content: '특별법상 피해자로 인정받으려면 거주 시·도청 또는 국토교통부에 결정신청서를 제출한다. 심의 기간은 통상 60일 이내이며, 인정 시 다양한 지원 혜택을 받을 수 있다. 신청 비용은 없으며 변호사 대리 없이 본인 신청도 가능하다.',
        key_points: [
...
//# sourceMappingURL=lawSummary.js.map